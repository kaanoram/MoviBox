...
if(isset($_POST["savePasswordButton"])) {
    ...
    $newPassword2 = FormSanitizer::sanitizeFormEmail($_POST["email"]);
...
<div class = "settingsContainer column">
    <div class = "formSection">
        <form method="POST">
            ...
            <input type="submit" name="saveDetailsButton" placeholder="Save">
        </form>
    </div>
    <div class = "formSection">
        <form method="POST">
            ...
            <input type="submit" name="savePasswordButton" placeholder="Save">
        </form>
    </div>
    ...
    <div class = "formSection">
        ...
        if($user->getIsSubscribed()) {
            ...
            echo "<a href='billing.php'>Subscribe to MoviBox</a>";
        }
        ?>
    </div>
</div>